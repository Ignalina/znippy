...
const SKIPPED_EXTENSIONS: &[&str] = &[
    // Archive formats
    "zip", "gz", "bz2", "xz", "7z", "rar", "lz", "lz4", "zst", "tar", "tar.gz", "tar.bz2", "tar.xz",
    "tgz", "tbz", "txz", // Java / Android
    "jar", "war", "ear", "apk", // Disk images
    "iso", "img", "dmg", // Audio formats
    "mp3", "aac", "ogg", "flac", "m4a", "wma", "opus", // Video formats
    "mp4", "mkv", "avi", "mov", "webm", "flv", "wmv", // Image formats
    "jpg", "jpeg", "png", "gif", "webp", "heic", "avif",
    // Office + PDF (already zipped)
    "docx", "xlsx", "pptx", "pdf", // Executables & libraries
