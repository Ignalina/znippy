...
pub const ZSTD_VERSION_NUMBER: u32 = 10508;
...
pub type ZSTD_ErrorCode = ::std::os::raw::c_uint;
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn ZSTD_getErrorName(result: usize) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
...
pub type ZSTD_strategy = ::std::os::raw::c_uint;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ZSTD_bounds"][::std::mem::size_of::<ZSTD_bounds>() - 16usize];
    ["Alignment of ZSTD_bounds"][::std::mem::align_of::<ZSTD_bounds>() - 8usize];
    ["Offset of field: ZSTD_bounds::error"][::std::mem::offset_of!(ZSTD_bounds, error) - 0usize];
    ["Offset of field: ZSTD_bounds::lowerBound"]
        [::std::mem::offset_of!(ZSTD_bounds, lowerBound) - 8usize];
    ["Offset of field: ZSTD_bounds::upperBound"]
        [::std::mem::offset_of!(ZSTD_bounds, upperBound) - 12usize];
};
unsafe extern "C" {
...
pub type ZSTD_ResetDirective = ::std::os::raw::c_uint;
unsafe extern "C" {
...
pub type ZSTD_dParameter = ::std::os::raw::c_uint;
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ZSTD_inBuffer_s"][::std::mem::size_of::<ZSTD_inBuffer_s>() - 24usize];
    ["Alignment of ZSTD_inBuffer_s"][::std::mem::align_of::<ZSTD_inBuffer_s>() - 8usize];
    ["Offset of field: ZSTD_inBuffer_s::src"]
        [::std::mem::offset_of!(ZSTD_inBuffer_s, src) - 0usize];
    ["Offset of field: ZSTD_inBuffer_s::size"]
        [::std::mem::offset_of!(ZSTD_inBuffer_s, size) - 8usize];
    ["Offset of field: ZSTD_inBuffer_s::pos"]
        [::std::mem::offset_of!(ZSTD_inBuffer_s, pos) - 16usize];
};
#[doc = "  Streaming"]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ZSTD_outBuffer_s"][::std::mem::size_of::<ZSTD_outBuffer_s>() - 24usize];
    ["Alignment of ZSTD_outBuffer_s"][::std::mem::align_of::<ZSTD_outBuffer_s>() - 8usize];
    ["Offset of field: ZSTD_outBuffer_s::dst"]
        [::std::mem::offset_of!(ZSTD_outBuffer_s, dst) - 0usize];
    ["Offset of field: ZSTD_outBuffer_s::size"]
        [::std::mem::offset_of!(ZSTD_outBuffer_s, size) - 8usize];
    ["Offset of field: ZSTD_outBuffer_s::pos"]
        [::std::mem::offset_of!(ZSTD_outBuffer_s, pos) - 16usize];
};
